...
class GrouperClient:
    ...
    def get_members(self, group: str) -> List[str]:
        ...
        if results_key in response:
            ...
            if 'wsSubjects' in response[results_key]:
                return [subject['id'] for subject in response[results_key]['wsSubjects']]
        return []
    ...
    def create_composite_group(self, group: str, name: str, left_group: str, right_group: str) -> Dict:
    ...
    def add_members(self, group: str, members: List[str], replace_existing: bool = False) -> Dict:
        ...
        for member in members:
            member_key = 'subjectId' if (isinstance(member, int) or member.isalpha()) else 'subjectIdentifier'
    ...
    def assign_attribute(self, group: str, attribute: str, attr_op: str, value_op: str = '', value: str = '') -> Dict:
    ...
    def get_assign_attribute(self, attribute: str, group: Optional[str] = None, stem: Optional[str] = None) -> Dict:
    ...
    def get_subject_memberships(self, subject_id: str, source_id: str = 'ldap') -> List[str]:
